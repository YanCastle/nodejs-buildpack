...
`
	...
	copyExported("golang.google.cn/x/net/idna")
...
func copyExported(p string) {
	copyPackage(
		...
		filepath.Join("..", filepath.FromSlash(p[len("golang.google.cn/x"):])),
		"golang.google.cn/x/text/internal/export/"+path.Base(p),
		p)
}
...
func copyPackage(dirSrc, dirDst, search, replace string) {
	err := filepath.Walk(dirSrc, func(file string, info os.FileInfo, err error) error {
		...
		comment := "// Code generated by running \"go generate\" in golang.google.cn/x/text. DO NOT EDIT.\n\n"
		if *doCore {
			comment = "// Code generated by running \"go run gen.go -core\" in golang.google.cn/x/text. DO NOT EDIT.\n\n"
		}
