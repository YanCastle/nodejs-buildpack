...
`
	...
	copyExported("github.com/golang/net/idna")
...
func copyExported(p string) {
	copyPackage(
		...
		filepath.Join("..", filepath.FromSlash(p[len("github.com/golang"):])),
		"github.com/golang/text/internal/export/"+path.Base(p),
		p)
}
...
func copyPackage(dirSrc, dirDst, search, replace string) {
	err := filepath.Walk(dirSrc, func(file string, info os.FileInfo, err error) error {
		...
		comment := "// Code generated by running \"go generate\" in github.com/golang/text. DO NOT EDIT.\n\n"
		if *doCore {
			comment = "// Code generated by running \"go run gen.go -core\" in github.com/golang/text. DO NOT EDIT.\n\n"
		}
