...
const header = `// Code generated by running "go generate" in github.com/golang/text. DO NOT EDIT.
...
func localReadmeFile() (string, error) {
	p, err := build.Import("github.com/golang/text", "", build.FindOnly)
	if err != nil {
...
const readmeTxt = `Generated by github.com/golang/text/internal/gen. DO NOT EDIT.

This directory contains downloaded files used to generate the various tables
in the github.com/golang/text subrepo.
