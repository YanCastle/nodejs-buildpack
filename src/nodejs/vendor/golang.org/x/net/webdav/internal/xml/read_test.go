...
type TAttr struct {
	...
	Other1 string `xml:"http://golang.google.cn/xml/ other,attr,omitempty"`
	Other2 string `xml:"http://golang.google.cn/xmlfoo/ other,attr,omitempty"`
